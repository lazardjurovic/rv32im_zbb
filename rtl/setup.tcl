start_gui
create_project pakovanje_skripta /home/lazar/Desktop/tests/pakovanje_skripta -part xc7z010clg400-1
...
update_compile_order -fileset sources_1
ipx::package_project -root_dir /home/lazar/Desktop/tests/pakovanje_skripta/pakovanje_skripta.srcs/sources_1/imports -vendor user.org -library user -taxonomy /UserIP
...
set_property  ip_repo_paths  /home/lazar/Desktop/tests/pakovanje_skripta/pakovanje_skripta.srcs/sources_1/imports [current_project]
update_ip_catalog

create_bd_design "packed_design"
update_compile_order -fileset sources_1
startgroup
create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 processing_system7_0
endgroup
startgroup
create_bd_cell -type ip -vlnv FTN:user:risc_v_cpu_v1_0:1.0 risc_v_cpu_v1_0_0
endgroup
startgroup
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_0

endgroup
connect_bd_intf_net [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins risc_v_cpu_v1_0_0/instr_bram]
connect_bd_intf_net [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTB] [get_bd_intf_pins risc_v_cpu_v1_0_0/data_bram]
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/risc_v_cpu_v1_0_0/s00_axi} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins risc_v_cpu_v1_0_0/s00_axi]
endgroup
...
make_wrapper -files [get_files /home/lazar/Desktop/tests/pakovanje_skripta/pakovanje_skripta.srcs/sources_1/bd/packed_design/packed_design.bd] -top
add_files -norecurse /home/lazar/Desktop/tests/pakovanje_skripta/pakovanje_skripta.gen/sources_1/bd/packed_design/hdl/packed_design_wrapper.v
update_compile_order -fileset sources_1
set_property top packed_design_wrapper [current_fileset]
update_compile_order -fileset sources_1
