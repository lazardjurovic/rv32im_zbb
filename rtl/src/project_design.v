...
module project_design
  ...
  project_design_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  project_design_axi_smc_0 axi_smc
  ...
  project_design_processing_system7_0_0 processing_system7_0
  ...
  project_design_risc_v_cpu_0_1 risc_v_cpu_0
       (.data_mem_clk(axi_bram_ctrl_0_BRAM_PORTB_CLK),
        .data_mem_init_addr({1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTB_ADDR}),
        .data_mem_init_data_in(axi_bram_ctrl_0_BRAM_PORTB_DIN),
        .data_mem_init_data_out(axi_bram_ctrl_0_BRAM_PORTB_DOUT),
        .data_mem_init_enable(axi_bram_ctrl_0_BRAM_PORTB_EN),
        .data_mem_init_we(axi_bram_ctrl_0_BRAM_PORTB_WE),
        .data_mem_reset(axi_bram_ctrl_0_BRAM_PORTB_RST),
        .instr_mem_clk(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .instr_mem_init_addr({1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .instr_mem_init_data_in(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .instr_mem_init_data_out(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .instr_mem_init_enable(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .instr_mem_init_we(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .instr_mem_reset(axi_bram_ctrl_0_BRAM_PORTA_RST),
  ...
  project_design_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
